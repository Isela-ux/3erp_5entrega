...
// Puedes insertar esta sección en cualquier parte del contenido
// Por ejemplo, al inicio del contenido principal:
mainContent.appendChild(seccionPresentacion);

// Cambiar frases automáticamente con transición
setInterval(() => {
